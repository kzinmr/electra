    ...
    def _load_glue(
        ...
        for (i, line) in enumerate(lines):
            try:
                ...
                utils.log(
                    "Error constructing example from line",
                    i,
                    "for task",
                    self.name + ":",
                    ex,
...
class ClassificationTask(SingleOutputTask):
    ...
    def __init__(
        self, config: configure_finetuning.FinetuningConfig, name, tokenizer, label_list
    ):
...
class MNLI(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(MNLI, self).__init__(
            config, "mnli", tokenizer, ["contradiction", "entailment", "neutral"]
        )
...
class RTE(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(RTE, self).__init__(
            config, "rte", tokenizer, ["entailment", "not_entailment"]
        )
...
class QNLI(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(QNLI, self).__init__(
            config, "qnli", tokenizer, ["entailment", "not_entailment"]
        )
